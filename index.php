    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                <a class="sidebar-brand brand-logo w-100" href="index.php"><img src="assets/images/logo.svg"
                        class="img w-100" alt="logo" /></a>
                <a class="sidebar-brand brand-logo-mini" href="index.php"><img src="assets/images/logo-mini.svg"
                        class="img w-100 pr-4" alt="logo" /></a>
            </div>
            <ul class="nav">
                                ...
                                <div class="card-body py-0 px-0 px-sm-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-5 col-sm-7 col-xl-8 p-0">
                                            ...
                                            <p class="mb-0 font-weight-normal d-none d-sm-block">mencari penjumlahan
                                                terbobot dari rating kinerja pada setiap alternatif di semua atribut.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col">
                                                ...
                                                <div id="the-basics">
                                                    <input class="typeahead" type="number" id="num_criteria"
                                                        name="num_criteria" value="<?= $num_criteria ?>" min="1"
                                                        max="100" required placeholder="Masukkan jumlah Kriteria">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <label>Alternatif</label>
                                                <div id="bloodhound">
                                                    <input class="typeahead" type="number" id="num_alternatives"
                                                        name="num_alternatives" value="<?= $num_alternatives ?>" min="2"
                                                        max="100" required placeholder="Masukkan jumlah Alternatif">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between w-100">
                                        <button type="button" class="btn btn-inverse-primary btn-fw w-50 m-1"
                                            onclick="generateInputs()">Generate Inputs</button>
                                        <button type="button" class="btn btn-inverse-danger btn-fw w-50 m-1"
                            ...
                            <div class="col-12 grid-margin stretch-card">
                                <div class="card">
                                    ...
                                    <button type="submit" id="hitungButton"
                                        class="btn btn-inverse-success btn-fw m-1">Hitung</button>
                                </div>
                            </div>
                    </form>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <?php if ($_SERVER['REQUEST_METHOD'] === 'POST'): ?>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <?php foreach ($types as $type): ?>
                                                    <td
                                                        class="table-dark <?= ($type == 'b') ? 'text-success' : 'text-danger text' ?>">
                                                        <?= ($type == 'b') ? 'Benefit' : 'Cost' ?>
                                                    </td>
                                                <?php endforeach; ?>
                                            </tr>
                                            ...
                                            foreach ($criteria as $i => $row): ?>
                                                <tr>
                                                    <td class="table-dark text-light font-weight-medium">
                                                        <?= $alternative_names[$i] ?></td>
                                                    <?php foreach ($row as $j => $item): ?>
                                                        <td
                                                            class="<?= ($item == $highlighted_values[$j] && $types[$j] == 'c') ? 'text-danger' : (($item == $highlighted_values[$j] && $types[$j] == 'b') ? 'text-success' : '') ?>">
                                                            <?= $item ?> <i
                                                                class="<?= ($item == $highlighted_values[$j] && $types[$j] == 'c') ? 'mdi mdi-arrow-down small' : (($item == $highlighted_values[$j] && $types[$j] == 'b') ? 'mdi mdi-arrow-up small' : '') ?>"></i>
                                                        </td>
                                                    <?php endforeach; ?>
                                                </tr>
                                            <?php endforeach; ?>
                                    ...
                                    <p class="text-muted" style="line-height: 0.5;">*Klik tombol dibawah ini untuk melihat
                                        penjelasan</p>
                                    <button class="btn btn-inverse-info w-100 mb-2" type="button" data-toggle="collapse"
                                    ...
                                    <div class="collapse" id="collapseContent">
                                        <div class="card card-body">
                                            <p class="text small">
                                                ...
                                                <mark class="bg-dark text-light">R<span class="text small">ii</span> = (
                                                    <span class="text-muted">X<span class="text small">ij</span></span> /
                                                    <span class="text text-success">max{X<span
                                                            class="text small">ij</span>}</span>)</mark><br>
                                                Maksud dari rumus diatas adalah : <br>
                                                R<span class="text small">ii</span> : Nilai normalisasi dari alternatif i
                                                pada kriteria j <br>
                                                <span class="text-muted">X<span class="text small">ij</span></span> : Nilai
                                                asli dari alternatif i pada kriteria j <br>
                                                <span class="text text-success">max{X<span
                                                        class="text small">ij</span>}</span> : Nilai maksimum dari semua
                                                alternatif pada kriteria j <br>
                                                <mark class="bg-light">Penjelasan : Setiap nilai pada kolom dengan kriteria
                                                    benefit dibagi dengan nilai tertinggi dari kolom tersebut</mark>
                                            </p>
                                            <p class="text small">
                                                <mark class="bg-danger">Kriteria Cost :</mark>
                                                <mark class="bg-dark text-light">R<span class="text small">ii</span> = (
                                                    <span class="text text-danger">min{X<span
                                                            class="text small">ij</span>}</span> / <span
                                                        class="text-muted">X<span
                                                            class="text small">ij</span></span>)</mark>
                                                <br>
                                                Maksud dari rumus diatas adalah : <br>
                                                R<span class="text small">ii</span> : Nilai normalisasi dari alternatif i
                                                pada kriteria j <br>
                                                ...
                                                asli dari alternatif i pada kriteria j <br>
                                                <span class="text text-danger">min{X<span
                                                        class="text small">ij</span>}</span> : Nilai minimum dari semua
                                                alternatif pada kriteria j <br>
                                                <mark class="bg-light">Penjelasan : Nilai terendah pada kolom dengan
                                                    kriteria benefit dibagi dengan Setiap nilai pada kolom tersebut </mark>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="table-responsive w-100 table-bordered">
                                    ...
                                    <div class="table-responsive w-100 table-bordered mb-5">
                                        <table class="table table-hover text-light">
                                            ...
                                            <?php foreach ($normalized_criteria as $i => $row): ?>
                                                <tr>
                                                    <td class="table-dark text-light font-weight-medium"><?= $i + 1 ?></td>
                                                        ...
                                                        <div class="col-md-5">
                                                            ...
                                                            <div class="table-responsive h-75" style="overflow-y: scroll;">
                                                                <table class="table">
                                                                    ...
                                                                    <thead class="table position-sticky"
                                                                        style="top: 0; background-color: #191c24; z-index: 1000;">
                                                                        <tr>
                                                                            <th>#</th>
                                                                            <th>Nama</th>
                                                                            <th id="nilai-header" class="sortable"
                                                                                style="cursor: pointer;">Nilai</th>
                                                                        </tr>
                                                                    </thead>
                                                                    <tbody id="table-body">
                                                                        <?php
            ...
            <footer class="footer">
                <div class="d-flex flex-column align-items-center">
                    ...
                    <div class="social-icons text-center">
                        ...
                        <a href="https://github.com/Lukman754" target="_blank" class="mx-3">
