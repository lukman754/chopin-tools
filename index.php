  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo w-100" href="index.html"><img src="assets/images/logo.svg" alt="logo" /></a>
      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          <a class="nav-link" href="index.php">
            ...
            <span class="menu-title">SAW</span>
          </a>
        </li>
      </ul>
    </nav>
            ...
            <div class="card">
              <div class="card-body">
                <?php if ($_SERVER['REQUEST_METHOD'] === 'POST') : ?>
                  ...
                  <div class="d-flex">
                    <h4 class="mt-5">Proses Perhitungan Normalisasi
                      <button class="btn" type="button" data-toggle="collapse" data-target="#collapseContent" aria-expanded="false" aria-controls="collapseContent">
